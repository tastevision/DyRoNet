...
class Exp(MyExp):
    def __init__(self):
        ...
        self.long_cfg = [
            dict(fusion_form='long_fusion', frame_num=3, delta=1, with_short_cut=False, include_current_frame=False, out_channels=[((
    ...
    def get_model(self):
        ...
        from exps.model.longshort_backbone_neck_lsn import BACKBONENECK
        ...
        if getattr(self, "model", None) is None:
            ...
            long_backbone = nn.ModuleList([
                DFPPAFPNLONGV3(depth, 
                               width, 
            ...
            short_backbone = nn.ModuleList([
                DFPPAFPNSHORTV3(depth, 
                                width, 
                                in_channels=in_channels, 
            ...
            self.model = YOLOXLONGSHORTV3(speed_detector,
                                       long_backbone, 
                                       short_backbone, 
                                       backbone_neck,
                                       head, 
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False, local_rank=0, cache_img=False):
        from exps.dataset.distillation.longshort.tal_flip_long_short_argoversedataset import LONGSHORT_ARGOVERSEDataset
        from exps.data.tal_flip_mosaicdetection_LSN import LongShortMosaicDetection
        from exps.data.data_augment_flip_LSN import LongShortTrainTransform
