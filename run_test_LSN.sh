#!/bin/bash
EXP_DIR=dynamic_LSN_s_20231229
ROUTER_TRAIN_DIR=dynamic_LSN_s_20231229
CFGS=cfgs/streamdynamic_LSN_s
CKPT=./models/checkpoints/streamdynamic_LSN_branch2_untrained_s.pth
...
# after branch train
CUDA_VISIBLE_DEVICES=0 python tools/train_dil.py -f $CFGS \
                          -c ./data/output/$EXP_DIR/best_ckpt.pth \
                          --experiment-name $EXP_DIR \
                          --router-mode random \
